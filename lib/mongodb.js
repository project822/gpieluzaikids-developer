...
function createConnection() {
  if (!uri) {
    ...
    const error = new Error(
      'MONGODB_URI belum diisi di .env.local. Salin connection string dari MongoDB Atlas: Database > Connect > Drivers.'
    );
...
// Ambil database operasional dashboard — ini yang dipakai di route handler:
